class Timeslot:
    ...
    def __init__(self, date, consumption, production, price):
        ...
        self.cost_prod = 0.01 #CHF/kWh
        self.cost_batt = 0.02 #CHF/kWh
        self.price_sell_to_grid = 0.1 #CHF/kWh
    ...
    def dump_battery(self): # valeurs en lien avec l'utilisation de la batterie
